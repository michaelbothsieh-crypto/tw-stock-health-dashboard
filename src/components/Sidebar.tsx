...
import { LayoutDashboard, ScanSearch, Search } from "lucide-react";
    ...
    <aside className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-neutral-800 lg:bg-neutral-950 lg:p-4">
      <div className="flex-1">
        ...
        <nav className="flex flex-col gap-1.5 text-sm font-bold text-neutral-400">
          <Link
            href="/"
            className="flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 hover:text-neutral-100"
          >
      ...
      <div className="mt-auto border-t border-neutral-800/50 px-2 pt-4">
        <VisitorStats />
      </div>
    </aside>
  );
