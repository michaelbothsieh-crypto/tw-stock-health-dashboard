...
import { handleTelegramMessage } from "@/features/telegram/botEngine";
import { registerChatId } from "@/features/telegram/chatStore";
...
export async function POST(req: Request) {
  try {
    ...
    const ALLOWED_COMMANDS = ["/stock", "/etf", "/whatis", "/setlist", "/start", "/help", "/rank", "/roi", "/twrank", "/usrank", "/hot"];
